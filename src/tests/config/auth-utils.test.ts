...
describe('normalizeOpenAICompatibleBaseUrl', () => {
  ...
  // --- Azure relay URL ---
  it('preserves an Azure relay URL with /v1 suffix', () => {
    expect(
      normalizeOpenAICompatibleBaseUrl('https://relay.example.com/coproxy/v1')
    ).toBe('https://relay.example.com/coproxy/v1');
  });
