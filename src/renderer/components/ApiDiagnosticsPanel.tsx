...
export default function ApiDiagnosticsPanel({
  ...
  return (
    <div className="space-y-3 rounded-2xl border border-border-muted bg-surface/55 p-3 shadow-[0_12px_30px_rgba(0,0,0,0.035)]">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="inline-flex h-11 items-center gap-2 rounded-xl border border-border-muted bg-background px-4 text-sm font-medium text-text-primary transition-colors hover:bg-surface-hover disabled:cursor-not-allowed disabled:opacity-50"
          >
            {isRunning ? (
        ...
        {actionSlot && <div className="w-full sm:w-auto">{actionSlot}</div>}
      </div>
