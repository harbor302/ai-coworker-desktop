            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="flex shrink-0 items-center gap-1 whitespace-nowrap text-xs px-2 py-1 rounded-md transition-all bg-surface-hover text-text-secondary hover:bg-surface-active disabled:opacity-50"
                  disabled={isRefreshingModels}
                >
                  <RefreshCw className={`w-3 h-3 ${isRefreshingModels ? 'animate-spin' : ''}`} />
                  {isRefreshingModels ? t('api.refreshingModels') : t('api.fetchModelsFromApi')}
                </button>
                {shouldShowOllamaManualModelToggle && (
                  <button
                    type="button"
                    onClick={toggleCustomModel}
                    className={`flex shrink-0 items-center gap-1 whitespace-nowrap text-xs px-2 py-1 rounded-md transition-all ${
                      useCustomModel
                  ...
                  >
                    ...
                    {useCustomModel ? t('api.useFetchedModels') : t('api.manualModel')}
                  </button>
                )}
              </div>
            </div>
