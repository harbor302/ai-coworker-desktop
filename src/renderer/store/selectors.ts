...
import type { GlobalNotice, PluginsTab, SessionExecutionClock } from './index';
...
/** Returns whether the active session is currently being replayed. */
export function useIsReplaying(): boolean {
  return useAppStore((s) =>
    s.activeSessionId ? s.replayState[s.activeSessionId] === 'playing' : false
  );
}
