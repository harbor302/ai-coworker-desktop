...
describe('pi model resolution helpers', () => {
  ...
  it('sets requiresReasoningContentOnAssistantMessages for DeepSeek V4 models on custom endpoints', () => {
    const model = applyPiModelRuntimeOverrides(
      {
        id: 'deepseek-v4-pro',
  ...
  it('sets requiresReasoningContentOnAssistantMessages for provider-prefixed DeepSeek V4 model ids', () => {
    const model = applyPiModelRuntimeOverrides(
      {
  ...
  it('does not set requiresReasoningContentOnAssistantMessages for non-V4 DeepSeek models on custom endpoints', () => {
    const model = applyPiModelRuntimeOverrides(
      {
