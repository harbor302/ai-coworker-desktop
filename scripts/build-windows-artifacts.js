...
const LEGACY_CLEANUP_ARTIFACTS = [
  {
    source: path.join('resources', 'windows', 'Coworker-Legacy-Cleanup.cmd'),
    target: 'Coworker-Legacy-Cleanup.cmd',
  },
  {
    source: path.join('resources', 'windows', 'Coworker-Legacy-Cleanup.ps1'),
    target: 'Coworker-Legacy-Cleanup.ps1',
  },
];
